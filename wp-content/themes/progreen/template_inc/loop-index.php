...
if (have_posts()) :
	...
	while (have_posts()) : the_post();
        ...
        <article id="post-<?php echo the_ID(); ?>" <?php echo post_class('row-fluid blog-article normal'); ?>>                    
        ...
        <?php if(is_single() && themeple_post_meta(get_the_ID() , 'author_id') != ''): $id = themeple_post_meta(get_the_ID() , 'author_id'); ?>

        <div class="post_author">
            
            <dl class="dl-horizontal">
                <dt><img src="<?php echo themeple_image_by_id(get_post_thumbnail_id($id), array('width' => 1200, 'height' => 1200), 'url') ?>" alt=""></dt>
		  <?php 
