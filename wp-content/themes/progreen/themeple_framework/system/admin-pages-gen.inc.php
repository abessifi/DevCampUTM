...
if(! class_exists('themeple_adminpages_gen')){
    ...
    class themeple_adminpages_gen{
        ...
        function add_scripts(){
            ...
            wp_enqueue_script('jquery.fancybox', THEMEPLE_JS_URL . 'libraries/fancybox/source/jquery.fancybox.pack.js');
        ...
        function non_option_page_scripts()
		{
			...
			{	
                ...
                wp_enqueue_style('font_awesome_ie' , get_template_directory_uri() . '/css/font-awesome-ie7.min.css');
			}
		}
        /**
        ...
        function add_styles(){
            wp_enqueue_style( 'thickbox' );
            wp_enqueue_style('jquery.fancybox', THEMEPLE_JS_URL . 'libraries/fancybox/source/jquery.fancybox.css');
