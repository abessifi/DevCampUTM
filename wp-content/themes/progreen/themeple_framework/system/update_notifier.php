...
function get_latest_theme_version($interval) {
	...
	$notifier_file_url = 'http://themeple.co/notifier_paralex.xml';

	$db_cache_field = 'themeple-notifier-cache';
	$db_cache_field_last_updated = 'themeple-notifier-last-updated';
