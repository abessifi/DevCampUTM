scnShortcodeMeta={
	attributes:[
		...
		},
		{
			...
			selectValues:['anchor', 'button', 'submit']
        },
        {
        ...
        },
        {
            ...
            controlType:"select-control", 
			selectValues:['default', 'large', 'medium', 'small', 'mini']
        },
        {
			label:"Block level buttons",
			id:"block_level",
			help:"",
            controlType:"select-control", 
			selectValues:['no', 'yes']
